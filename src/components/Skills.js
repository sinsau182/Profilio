...
const Skills = () => {
  return (
    ...
    '>
      <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light
      p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:p-2 xs:text-xs '
      whileHover={{ scale: 1.05 }}
      >
        Web
      </motion.div>
      ...
      <Skill name='Android' x="-3vw" y="-12vw"/>
      ...
      <Skill name='AWS' x="-15vw" y="18vw"/>
      <Skill name='Github' x="0vw" y="22vw"/>
      <Skill name='Docker' x="-32vw" y="10vw"/>
      <Skill name='CSS' x="-15vw" y="-5vw"/>
      <Skill name='Kotlin' x="10vw" y="-5vw"/>
      <Skill name='XML' x="-32vw" y="-5vw"/>
