    ...
    dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'
        >
            ...
            <nav className='flex items-center justify-center flex-wrap'>
                <motion.a href='https://github.com/sinsau182' target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mr-3'
                >
                ...
                <motion.a href='https://www.linkedin.com/in/saurav-singh-15320a218/' target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mx-3'
                >
                ...
                <motion.a href='https://x.com/SauravS73486499' target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mx-3'
                >
                ...
                <motion.a href='https://www.instagram.com/singhsaurav182/' target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className='w-6 mx-3'
                >
                ...
                <motion.a href='https://in.pinterest.com/singhsaurav182001/' target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
